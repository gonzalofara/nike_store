...
const Clips = ({ clip, imgsrc }) => {
  return (
    <div className="relative h-28 w-32 rounded-xl overflow-hidden group cursor-pointer transition-all duration-300 lg:w-28 md:w-24 sm:w-16 lg:h-24 md:h-20 xsm:h-14">
      <img
        src={imgsrc}
        alt="image/clips"
