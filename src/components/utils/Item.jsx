...
const Item = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={`flex items-center gap-3 ${!ifExists && "justify-center"}`}
      >
        <button
          type="button"
        ...
        <button
          type="button"
          className="bg-white/90 blur-effect-theme button-theme p-0.5 shadow-sky-200 text-sm text-black px-2 py-1"
          onClick={() => {
            onAddToCart();
            onCartToggle();
          }}
